...
function ChartViewModel() {
    ...
    //> Attributes
    self.WebAPIURL = ParentXrm.Page.context.getClientUrl() + "/api/data/v9.0";
    ...
    self.createDevicesBasedOnModelChart = function () {
        $.ajax({
            method: "GET",
            url: self.WebAPIURL +
                `/tlp_devices?$apply=filter(tlp_location_status ne 4 and _tlp_curent_newcontract_value eq `
                        + self.SelectedContract() +
                        ` and _tlp_currentbranch_value eq `
                        + self.SelectedBranch() +
                        `)/groupby((tlp_product/tlp_brand),aggregate($count as total))`,
            ...
            success: function (response) {
                ...
                self.ChartTitle("پایانه های موجود در شرکت بر اساس مدل");
    ...
    self.createDevicesBasedOnBrandChart = function () {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                self.SeriesName("تعداد دستگاه ها");
                self.ChartTitle("پایانه های فروش موجود در شرکت بر اساس برند - تعداد کل: " + totalCount);
    ...
    self.createAllDevicesChart = function () {
        ...
        $.ajax({
            method: "GET",
            url: self.WebAPIURL +
                "/tlp_devices?$filter=tlp_location_status ne 4 and _tlp_curent_newcontract_value eq "
                        + self.SelectedContract() +
                        " and _tlp_currentbranch_value eq "
                        + self.SelectedBranch() +
            ...
            success: function (response) {
                ...
                $.ajax({
                    method: "GET",
                    url: self.WebAPIURL +
                        "/tlp_devices?$filter=tlp_location_status eq 4 and _tlp_curent_newcontract_value eq "
                        + self.SelectedContract() +
                        " and _tlp_currentbranch_value eq "
                        + self.SelectedBranch() +
                        "&$apply=aggregate($count as total)",
                    ...
                    success: function (response) {
                        ...
                        self.SeriesName("تعداد دستگاه ها");
                        self.ChartTitle("همه ی پایانه های فروش - تعداد کل : " + allDevicesCount);
    ...
    self.getAllUnitsChartInfo = function () {
        ...
        $.ajax({
            method: "GET",
            url: self.WebAPIURL +
                "/tlp_devices?$filter=_tlp_curent_newcontract_value eq "
                + self.SelectedContract() +
                " and _tlp_currentbranch_value eq "
                + self.SelectedBranch() +
                " &$apply=groupby((tlp_location_status),aggregate($count as total))",
            contentType: "application/json; charset=utf-8",
            datatype: "json",
            data: {},
            beforeSend: function (XMLHttpRequest) {
            ...
            success: function (response) {
                ...
                self.SeriesName("تعداد دستگاه ها");
                self.ChartTitle("پایانه های فروش موجود در هر واحد - تعداد کل : " + allDevicesCount);
  ...
  <entity name="tlp_repaire">
    ...
    <link-entity name="tlp_device" from="tlp_deviceid" to="tlp_device" link-type="inner" alias="Device">
      <filter>
        <condition attribute="tlp_curent_newcontract" operator="eq" value="`+self.SelectedContract()+`" uitype="entitlement" />
        <condition attribute="tlp_currentbranch" operator="eq" value="`+self.SelectedBranch()+`" uitype="tlp_branch" />
      </filter>
    </link-entity>
  </entity>
</fetch>`;
        $.ajax({
            ...
            success: function (response) {
                ...
                self.SeriesName("تعداد دستگاه ها");
                self.ChartTitle("تعمیر نشده ها - تعداد کل : " + total);
        ...
        <condition attribute="tlp_date" operator="eq" value="`+ self.convertDateToJSONFormat(self.MiladiEndDate()) + `" />
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        self.SeriesName("تعداد دستگاه ها");
                        self.ChartTitle("پایانه های فروش");
      ...
      <filter>
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                self.SeriesName("تعداد دستگاه ها");
                self.ChartTitle("پایانه های فروش خارج شده بر اساس مدل - تعداد کل :" + total);
      ...
      <filter>
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                self.SeriesName("تعداد دستگاه ها");
                self.ChartTitle("پایانه های فروش واحد فنی - تعداد کل : " + total);
      ...
      <filter>
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                self.SeriesName("تعداد دستگاه ها");
                self.ChartTitle("پایانه های فروش واحد کنترل کیفیت - تعداد کل: " + total);
            ...
            success: function (response) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        self.SeriesName("تعداد دستگاه ها");
                        self.ChartTitle("پایانه های فروش واحد پذیرش - تعداد کل : " + total);
      ...
      <filter>
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (response.value.length == 0) {
                    self.ChartTitle("پایانه های فروش در دست تعمیر واحد فنی - تعداد کل : " + total);
      ...
      <filter>
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (response.value.length == 0) {
                    self.ChartTitle("پایانه های فروش عودت داده شده واحد فنی - تعداد کل : " + total);
      ...
      <filter>
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (response.value.length == 0) {
                    self.ChartTitle("پایانه های فروش تعمیر شده واحد فنی - تعداد کل : " + total);
      ...
      <filter>
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (response.value.length == 0) {
                    self.ChartTitle("پایانه های فروش منتظر قطعه واحد فنی - تعداد کل : " + total);
      ...
      <filter>
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (response.value.length == 0) {
                    self.ChartTitle("پایانه های فروش غیر قابل تعمیر واحد فنی - تعداد کل : " + total);
      ...
      <filter>
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                self.SeriesName("تعداد دستگاه ها");
                self.ChartTitle("پایانه های فروش در دست اقدام واحد کنترل کیفیت - تعداد کل : " + total);
      ...
      <filter>
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                self.SeriesName("تعداد دستگاه ها");
                self.ChartTitle("پایانه های فروش QC شده ی واحد کنترل کیفیت - تعداد کل : " + total);
      ...
      <filter>
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                self.SeriesName("تعداد دستگاه ها");
                self.ChartTitle("پایانه های فروش در دست اقدام واحد تنظیف - تعداد کل : " + total);
      ...
      <filter>
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                self.SeriesName("تعداد دستگاه ها");
                self.ChartTitle(" پایانه های فروش تنظیف شده ی واحد تنظیف - تعداد کل : " + total);
      ...
      <filter>
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                self.ChartTitle(" پایانه های فروش در دست تنظیف بر اساس مدل - تعداد کل : " + total);
  ...
  <entity name="tlp_repaire" >
    ...
    self.fillInOutDevicesCountArrayPerMonth = function (response) {
        ...
        self.ChartTitle("دستگاه های ورودی و خروجی بر اساس ماه");
  ...
  <entity name="tlp_device_history" >
      ...
      <filter>
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                self.ChartTitle("دستگاه های خروجی بر اساس ماژول ارتباطی در بازه زمانی منتخب - تعداد کل: " + total);
    ...
    self.fillInOutDevicesCountArrayPerYear = function (response) {
        ...
        self.ChartTitle("دستگاه های ورودی و خروجی بر اساس سال");
        if (outDevicesCount.length == diff)
    ...
    self.getBranches = function(){
        $.ajax({
            method: "GET",
            url: self.WebAPIURL + "/tlp_branchs?$select=tlp_name,tlp_branchid",
            contentType: "application/json; charset=utf-8",
            datatype: "json",
            data: {},
            beforeSend: function (XMLHttpRequest) {
            ...
            success: function (response) {
                console.log(response);
                response.value.forEach(function(item, index){
                    self.BranchList.push({name: item.tlp_name, id: item.tlp_branchid})
                });
            }
        });
    }
    self.getContracts = function(){
        $.ajax({
            method: "GET",
            url: self.WebAPIURL + "/entitlements?$select=name,entitlementid",
            contentType: "application/json; charset=utf-8",
            datatype: "json",
            data: {},
            beforeSend: function (XMLHttpRequest) {
            ...
            success: function (response) {
                console.log(response);
                response.value.forEach(function(item, index){
                    self.ContractList.push({name: item.name, id: item.entitlementid})
                });
            }
        });
    }
